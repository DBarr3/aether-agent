...
#### `aether memory [init|status|diff|commit|push|pull|sync|log|show|graph|reconcile|inspect|forget|prune]`

commit and synchronize project memory; inspect memory tiers
